module PressHelper
  ...
  def press_position_options
    ["Publisher", "Editor-in-chief", "Deputy editor-in-chief", "Editor", "Correspondent", "Freelancer", "Photographer", "Technician", "Other"]
  end
  
  def publication_rhythm_options
    ["Daily", "Weekly", "Monthly", "Bi-monthly", "Quarterly", "Six-monthly", "Yearly"]
  end
