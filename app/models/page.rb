class Page < ActiveRecord::Base
  ...
  has_snippets :gallery_address, :gallery_phone, :gallery_fax, :gallery_email, :gallery_website, :gallery_facebook, :gallery_hours, :text_second
  ...
  class << self
    def view_names
      %w{basic tiled list gallery about}
    end
  end
